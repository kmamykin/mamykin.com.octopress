...
Initial reading:
<a href="http://download.java.net/jdk6/source/">Download JDK 1.6 source</a>
<a href="http://download.java.net/jdk6/6u15/promoted/b03/docs/build/README-builds.html">Official build instructions</a>
...
Example:
<pre lang="dos">java -jar jdk-6u15-fcs-src-b03-jrl-02_jul_2009.jar</pre>
<pre lang="dos">java -jar jdk-6u15-fcs-bin-b03-jrl-02_jul_2009.jar</pre>
...
It looks like the build system needs to be invoked from windows command line, not cygwin shell, which was a suprprise to me. I did not realize it was possible to call cygwin utilities from dos command line, I always used bash shell... anyway, back to cmd:
...
<pre lang="dos">set PATH=%SystemRoot%\system32;c:\cygwin\bin</pre>

6) Setup VS2003 environment variables:

Run vsvars32.bat for VS2003:

<pre lang="dos">C:\Misc\jdk6build\workspace>"\Program Files\Microsoft Visual Studio .NET 2003\Common7\Tools\vsvars32.bat"
